 ...
 */
public class ULSearchableSectionedListAdapter<T extends ULListItemBaseModel> extends ULSectionedListAdapter<T> implements Filterable {

    private ULItemFilter mFilter;
    private List<ULListItemBaseModel> mUnfilteredMenuItems;

    public ULSearchableSectionedListAdapter(Context context, List<ULListItemBaseModel> listItems) {
